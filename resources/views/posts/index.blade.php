    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            ...
            <a href="{{ route('posts.create') }}"
                class="mt-4 md:mt-0 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-2xl font-semibold shadow transition">
                ➕ Create Post
            </a>
        ...
        <div class="bg-white border border-gray-200 rounded-3xl p-6 shadow mb-8">
            ...
            <form method="GET"
                ...
                <input type="text"
                    ...
                    class="flex-1 bg-white border border-gray-300 text-gray-800 rounded-2xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500">

                <button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-2xl font-semibold transition">
                    🔍 Search
                </button>
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50 transition {{ $post->trashed() ? 'bg-red-50' : '' }}">
                            ...
                            <td class="px-6 py-4 text-gray-800 font-semibold">
                                ...
                                @if($post->trashed())
                                <span class="ml-2 text-xs bg-red-100 text-red-600 px-2 py-1 rounded-full">
                                    Deleted
                                </span>
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex justify-center flex-wrap gap-3">
                                    ...
                                    <form action="{{ route('posts.restore', $post->id) }}" method="POST">
                                        @csrf
                                        <button class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-xl font-semibold transition">
                                            Restore
                                        </button>
                                    </form>
                                    @else
